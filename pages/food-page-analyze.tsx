...
export default function FoodPageAnalyzePage() {
  ...
  const handleLanguageChange = (nextLanguage: SiteLanguage) => {
    ...
    void router.push(nextLanguage === 'en' ? PAGE_PATH : `/${nextLanguage}/`)
  }
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!accessToken) {
      ...
      setError({
        ...
        message: 'Sign in to Calkilo in this browser before analyzing a food page.',
      })
      return
    }
  ...
  return (
    ...
    >
      <SeoHead
        title="Food Page Analyzer | Calkilo"
        description="Analyze a restaurant or food item page URL with Calkilo."
        path={PAGE_PATH}
        noindex
        nofollow
      />
          ...
          <div className="lp-container fp-stack">
            ...
            {result ? (
              ...
              <section className="fp-card fp-empty-state" aria-live="polite">
                ...
                <p>Paste a restaurant or food item URL and run an analysis to see calories, macros, source metadata, saved meal data, and coin usage.</p>
              </section>
            )}
          </div>
        </section>
      ...
      <SiteFooter
        ...
        description="AI-powered calorie and nutrition tracking for real meals."
        homeAriaLabel="Calkilo home"
        homeHref="/"
